...
(function() {
  ...
  modalapp.controller('AppCtrl', function($modal) {
    var app;
    app = this;
  ...
  modalapp.controller('ModalCtrl', function($modalInstance) {
    ...
    return modal.getCurrentQuestion = function() {
...
(function() {
  ...
  app.controller('MainCtrl', function($scope, ngDialog) {
    return $scope.clickToOpen = function() {
      return ngDialog.open({
        template: 'popupTmpl',
        controller: [
          '$scope', function($scope) {
            return $scope.prompts = "Haha, so you think I'm the real Quade?!";
          }
        ]
      });
    };
