...
class VariablesControllerTest < ActionController::TestCase
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post :create, variable: { description: @variable.description, type_name: @variable.type_name, variable_type: @variable.variable_type }
    end
  ...
  test "should update variable" do
    patch :update, id: @variable, variable: { description: @variable.description, type_name: @variable.type_name, variable_type: @variable.variable_type }
    assert_redirected_to variable_path(assigns(:variable))
  end
